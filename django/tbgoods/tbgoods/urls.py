...
from tb.views import  TbList ,download_info,search_info,info_page,download_pl,search_pl,pl_page,download_jd_info,search_jd_info,jd_info_page,download_jd_pl,search_jd_pl,jd_pl_page             #引用的模板
